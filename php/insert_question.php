  ...
  <body>
      <div class="container-fluid">
        <div class="col-xs-9 col-sm-9">
            ...
            <?php
            if(isset($_POST['erwthsh']) && !empty($_POST['erwthsh']) && isset($_POST['eidos_erwthshs']) && !empty($_POST['eidos_erwthshs'])){
              ...
              echo "<h1>Πρέπει να επιλέξεις κάτι πρώτα</h1>";
              header( "Refresh:1; url=choose_lesson_for_questions.php", true, 303);
            }
